...
<html>
	...
	<body>
		<header> <!--Espacio para el título y el logo de la página-->
			<a href="inicio.php" ><img src="imagenes/logo.png" id="logo"></a>
			<hgroup>
				<h1 align="left">Máquinas de Leonardo Da Vinci.</h1>
				<h2 class="tagline">Planos de Construcción a Escala</h2>
			</hgroup>
		</header>
		<nav>
			<ul>
					...
					<?php
					       ...
					       if ($result = $mysqli->query($query)) {
							    while ($row = $result->fetch_assoc()) {
							      ...
							      print("<h2>".$nombre."</h2>");
					              print("<object type='application/pdf' data='".$plano."' style='width: 500px; height: 650px;'></object> ");
							      print("</li>");
